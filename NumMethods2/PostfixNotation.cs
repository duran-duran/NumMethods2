...
namespace NumMethods2
{
    ...
    class PostfixNotation
    {
        ...
        {
            Stack<string> stack = new Stack<string>();
            Queue<string> queue = new Queue<string>(Signify(x));
        ...
        private string[] Signify(double x)
        {
        ...
        //Проверка на то, является ли константой выражение, записанное нотацией
        public bool IsConst()
        {
            return !separated_notation.Contains("x");
        }
